...
```{r irisWide}
library(tidyverse)
iris.wide <- gather(iris, PartW, Width, Sepal.Width, Petal.Width) %>% 
        gather(PartL, Length, Sepal.Length, Petal.Length) %>% 
        gather(PartDel, Part, PartW, PartL) %>%
        select(-PartDel)
iris.wide$Part[iris.wide$Part == "Sepal.Width"] <- "Sepal"
iris.wide$Part[iris.wide$Part == "Sepal.Length"] <- "Sepal"
iris.wide$Part[iris.wide$Part == "Petal.Width"] <- "Petal"
iris.wide$Part[iris.wide$Part == "Petal.Width"] <- "Petal"
iris.wide <- select(iris.wide, Species, Part, Length, Width)
head(iris.wide)
```
